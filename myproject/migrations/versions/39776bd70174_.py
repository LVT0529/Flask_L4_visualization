...
Revision ID: 39776bd70174
Revises: 
Create Date: 2023-04-25 16:26:33.405944
...
def upgrade():
    ...
    op.create_table('l4_pool',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_l4_pool'))
    )
    op.create_table('l4_wideip',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('wideip', sa.String(length=100), nullable=False),
    sa.Column('wideip_record', sa.String(length=20), nullable=False),
    sa.Column('wideip_status', sa.String(length=20), nullable=False),
    sa.Column('wideip_en', sa.String(length=20), nullable=False),
    sa.Column('wideip_lbmod', sa.String(length=20), nullable=False),
    sa.Column('wideip_rcof', sa.String(length=20), nullable=False),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_l4_wideip')),
    sa.UniqueConstraint('wideip', name=op.f('uq_l4_wideip_wideip'))
    )
...
def downgrade():
    ...
    op.drop_table('user')
    op.drop_table('l4_wideip')
    op.drop_table('l4_pool')
    # ### end Alembic commands ###
